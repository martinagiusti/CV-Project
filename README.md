...
The notebook [Faster RCNN_detection.ipynb](https://github.com/martinagiusti/CV-Project/blob/main/Faster RCNN_detection.ipynb) deals with Faster-R-CNN network development.
