...
def test(opt):
    ...
    with torch.no_grad():
        ...
        log.write(f'Frames per second (FPS): {fps:.2f}\n')
        log.close()


if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--label_file', type=str, required=True, help='path al file labels.txt')
    ...
    parser.add_argument('--PAD', action='store_true',default=False, help='whether to keep ratio then pad for image resize')
